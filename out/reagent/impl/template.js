...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__10876__auto__,writer__10877__auto__,opt__10878__auto__){
return cljs.core._write.call(null,writer__10877__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12301 = o;
(G__12301[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__12302__delegate = function (args){
...
return G__12302__delegate.call(this,args);};
...
return G__12302__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__10253__auto__ = !((jsprops == null));
if(and__10253__auto__){
var and__10253__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__10253__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__10253__auto____$1;
}
} else {
...
var G__12310 = jsprops;
(G__12310["defaultValue"] = value);

(G__12310["onChange"] = ((function (G__12310,v,value,on_change){
return (function (p1__12307_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12307_SHARP_);
});})(G__12310,v,value,on_change))
);

(G__12310["ref"] = ((function (G__12310,v,value,on_change){
return (function (p1__12308_SHARP_){
return (this$["cljsInputElement"] = p1__12308_SHARP_);
});})(G__12310,v,value,on_change))
);
...
var vec__12317 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12317,(0),null);
var id = cljs.core.nth.call(null,vec__12317,(1),null);
var class$ = cljs.core.nth.call(null,vec__12317,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12322 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___12322 == null)){
} else {
var key_12323 = temp__4661__auto___12322;
(jsprops["key"] = key_12323);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12325 = (new reagent.impl.template.NativeWrapper());
(G__12325["name"] = c);
...
var len__11378__auto___12331 = arguments.length;
var i__11379__auto___12332 = (0);
while(true){
if((i__11379__auto___12332 < len__11378__auto___12331)){
args__11385__auto__.push((arguments[i__11379__auto___12332]));

var G__12333 = (i__11379__auto___12332 + (1));
i__11379__auto___12332 = G__12333;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__11386__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12329){
var G__12330 = cljs.core.first.call(null,seq12329);
var seq12329__$1 = cljs.core.next.call(null,seq12329);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12330,seq12329__$1);
});
...
break;
default:
var G__12337 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12337;
continue;
...
var n__11188__auto___12340 = a.length;
var i_12341 = (0);
while(true){
if((i_12341 < n__11188__auto___12340)){
(a[i_12341] = reagent.impl.template.as_element.call(null,(a[i_12341])));
...
var a = cljs.core.into_array.call(null,s);
var n__11188__auto___12343 = a.length;
var i_12344 = (0);
while(true){
if((i_12344 < n__11188__auto___12343)){
var val_12345 = (a[i_12344]);
if((cljs.core.vector_QMARK_.call(null,val_12345)) && ((reagent.impl.template.key_from_vec.call(null,val_12345) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12344] = reagent.impl.template.as_element.call(null,val_12345));

var G__12346 = (i_12344 + (1));
i_12344 = G__12346;
continue;
} else {
}
...
var ctx = ({});
var vec__12350 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12350,(0),null);
var derefed = cljs.core.nth.call(null,vec__12350,(1),null);
...
var G__12354 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12354) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12354){
