...
var or__10265__auto__ = reagent.dom.server.imported = require("react-dom/server");
...
var _STAR_non_reactive_STAR_12571 = reagent.impl.util._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_12571;
}});
/**
...
var _STAR_non_reactive_STAR_12573 = reagent.impl.util._STAR_non_reactive_STAR_;
reagent.impl.util._STAR_non_reactive_STAR_ = true;

try{return (reagent.dom.server.module.call(null)["renderToStaticMarkup"])(reagent.impl.template.as_element.call(null,component));
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_12573;
}});
