...
return (function (s){
return cljs.core.boolean$.call(null,cljs.core.re_matches.call(null,re,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('')));
});
});
/**
...
var re = [cljs.core.str.cljs$core$IFn$_invoke$arity$1("(?i)[a-z0-9!#$%&'*+/=?^_`{|}~-]+"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(?:\\.[a-z0-9!#$%&'*+/=?"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("^_`{|}~-]+)*"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("[a-z0-9](?:[a-z0-9-]*[a-z0-9])?")].join('');
return cljs.core.boolean$.call(null,cljs.core.re_matches.call(null,cljs.core.re_pattern.call(null,re),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(email)].join('')));
});
/**
 * Returns true if the string represents an integer.
 */
valip.predicates.integer_string_QMARK_ = (function valip$predicates$integer_string_QMARK_(s){
return cljs.core.boolean$.call(null,cljs.core.re_matches.call(null,/\s*[+-]?\d+\s*/,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('')));
});
/**
...
return cljs.core.boolean$.call(null,cljs.core.re_matches.call(null,/\s*[+-]?\d+(\.\d+(M|M|N)?)?\s*/,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('')));
});
/**
...
return cljs.core.boolean$.call(null,cljs.core.re_matches.call(null,/\d+/,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('')));
});
/**
...
return cljs.core.boolean$.call(null,cljs.core.re_matches.call(null,/[A-Za-z0-9]+/,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('')));
});
valip.predicates.parse_number = (function valip$predicates$parse_number(x){
if(cljs.core.truth_((function (){var and__7103__auto__ = typeof x === 'string';
...
return (function (x){
var temp__4655__auto__ = valip.predicates.parse_number.call(null,x);
...
var uri = goog.Uri.parse([cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''));
var and__7103__auto__ = cljs.core.seq.call(null,uri.getScheme());
if(and__7103__auto__){
return cljs.core.re_find.call(null,/\/\//,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''));
} else {
return and__7103__auto__;
}
});
