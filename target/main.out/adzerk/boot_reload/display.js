...
var attr = cljs.core.nth.call(null,vec__9224,(0),null);
var v = cljs.core.nth.call(null,vec__9224,(1),null);
...
var args9227 = [];
var len__8228__auto___9230 = arguments.length;
var i__8229__auto___9231 = (0);
while(true){
if((i__8229__auto___9231 < len__8228__auto___9230)){
args9227.push((arguments[i__8229__auto___9231]));

var G__9232 = (i__8229__auto___9231 + (1));
i__8229__auto___9231 = G__9232;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args9227.length)].join('')));
...
var len__8228__auto___9235 = arguments.length;
var i__8229__auto___9236 = (0);
while(true){
if((i__8229__auto___9236 < len__8228__auto___9235)){
args__8235__auto__.push((arguments[i__8229__auto___9236]));

var G__9237 = (i__8229__auto___9236 + (1));
i__8229__auto___9236 = G__9237;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8236__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9234){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9234));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9238){
var map__9242 = p__9238;
var map__9242__$1 = ((((!((map__9242 == null)))?((((map__9242.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9242.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9242):map__9242);
var data = map__9242__$1;
var message = cljs.core.get.call(null,map__9242__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9242__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9242__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9244 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9244,goog.events.EventType.CLICK,((function (G__9244,map__9242,map__9242__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9244,map__9242,map__9242__$1,data,message,line,file))
);

return G__9244;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9245){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9252){
var map__9256 = p__9252;
var map__9256__$1 = ((((!((map__9256 == null)))?((((map__9256.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9256.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9256):map__9256);
var messages = map__9256__$1;
var warnings = cljs.core.get.call(null,map__9256__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9256__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9258 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9258,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9258,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9259){
var map__9262 = p__9259;
...
var messages = map__9262__$1;
var warnings = cljs.core.get.call(null,map__9262__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9262__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9262,map__9262__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9262,map__9262__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9262,map__9262__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9262,map__9262__$1,messages,warnings,exception))
;
