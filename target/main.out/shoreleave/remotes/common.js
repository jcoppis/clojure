...
var vec__9884 = route;
var m = cljs.core.nth.call(null,vec__9884,(0),null);
var u = cljs.core.nth.call(null,vec__9884,(1),null);
...
var temp__4655__auto__ = (function (){var and__7103__auto__ = cljs.core._EQ_.call(null,method,"POST");
...
var anti_forgery_token = temp__4655__auto__;
return cljs.core.merge.call(null,content_map,cljs.core.PersistentArrayMap.createAsIfByAssoc([shoreleave.remotes.common._STAR_csrf_token_name_STAR_,anti_forgery_token]));
} else {
return content_map;
}
});
...
cljs.core.PersistentArrayMap.prototype.shoreleave$remotes$protocols$ITransportData$ = cljs.core.PROTOCOL_SENTINEL;

cljs.core.PersistentArrayMap.prototype.shoreleave$remotes$protocols$ITransportData$_data_str$arity$1 = (function (t){
var t__$1 = this;
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.Uri.QueryData.createFromMap((new goog.structs.Map(cljs.core.clj__GT_js.call(null,t__$1)))))].join('');
});

cljs.core.PersistentHashMap.prototype.shoreleave$remotes$protocols$ITransportData$ = cljs.core.PROTOCOL_SENTINEL;
...
cljs.core.PersistentTreeMap.prototype.shoreleave$remotes$protocols$ITransportData$ = cljs.core.PROTOCOL_SENTINEL;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.Uri.QueryData.createFromMap((new goog.structs.Map(cljs.core.clj__GT_js.call(null,t)))))].join('');
}));
/**
