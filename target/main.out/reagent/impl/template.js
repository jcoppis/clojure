...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7726__auto__,writer__7727__auto__,opt__7728__auto__){
return cljs.core._write.call(null,writer__7727__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__9586 = o;
(G__9586[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__7103__auto__ = !((jsprops == null));
if(and__7103__auto__){
var and__7103__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__9595 = jsprops;
(G__9595["defaultValue"] = value);

(G__9595["onChange"] = ((function (G__9595,v,value,on_change){
return (function (p1__9592_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9592_SHARP_);
});})(G__9595,v,value,on_change))
);

(G__9595["ref"] = ((function (G__9595,v,value,on_change){
return (function (p1__9593_SHARP_){
return (this$["cljsInputElement"] = p1__9593_SHARP_);
});})(G__9595,v,value,on_change))
);
...
var vec__9602 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9602,(0),null);
var id = cljs.core.nth.call(null,vec__9602,(1),null);
var class$ = cljs.core.nth.call(null,vec__9602,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___9607 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___9607 == null)){
} else {
var key_9608 = temp__4661__auto___9607;
(jsprops["key"] = key_9608);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__9610 = (new reagent.impl.template.NativeWrapper());
(G__9610["name"] = c);
...
var len__8228__auto___9616 = arguments.length;
var i__8229__auto___9617 = (0);
while(true){
if((i__8229__auto___9617 < len__8228__auto___9616)){
args__8235__auto__.push((arguments[i__8229__auto___9617]));

var G__9618 = (i__8229__auto___9617 + (1));
i__8229__auto___9617 = G__9618;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8236__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9614){
var G__9615 = cljs.core.first.call(null,seq9614);
var seq9614__$1 = cljs.core.next.call(null,seq9614);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__9615,seq9614__$1);
});
...
break;
default:
var G__9622 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__9622;
continue;
...
var n__8038__auto___9625 = a.length;
var i_9626 = (0);
while(true){
if((i_9626 < n__8038__auto___9625)){
(a[i_9626] = reagent.impl.template.as_element.call(null,(a[i_9626])));
...
var a = cljs.core.into_array.call(null,s);
var n__8038__auto___9628 = a.length;
var i_9629 = (0);
while(true){
if((i_9629 < n__8038__auto___9628)){
var val_9630 = (a[i_9629]);
if((cljs.core.vector_QMARK_.call(null,val_9630)) && ((reagent.impl.template.key_from_vec.call(null,val_9630) == null))){
(o["no-key"] = true);
} else {
}

(a[i_9629] = reagent.impl.template.as_element.call(null,val_9630));
...
var ctx = ({});
var vec__9635 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__9635,(0),null);
var derefed = cljs.core.nth.call(null,vec__9635,(1),null);
...
var G__9639 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9639) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__9639){
